...
from main import PaymentProcessor, PaymentGateway, TransactionStatus, NetworkException, PaymentException, RefundException, TransactionResult
...
class TestPaymentProcessor(unittest.TestCase):
    ...
    def test_processPayment_success(self):
        #udana transakcja
        self.mock_gateway.charge.return_value = TransactionResult(True, "123", "Płatność zakończona sukcesem")
    ...
    def test_processPayment_failure(self):
        #nieudana transakcja
        self.mock_gateway.charge.return_value = TransactionResult(False, "123", "Niepowodzenie płatności")
    ...
    def test_refundPayment_success(self):
        ...
        self.mock_gateway.refund.return_value = TransactionResult(True, "123", "Zwrot zakończony sukcesem")
